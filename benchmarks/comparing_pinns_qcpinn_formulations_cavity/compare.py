"""Compare native cavity models through shared evaluation and reporting."""
...
DEFAULT_MODEL_PATHS = {
    variant: RESULTS_DIR / f"cavity_{variant.lower().replace('-', '_')}.pkl"
...
def main(argv=None):
    ...
    reference = None
    if not args.smoke and not args.no_reference and args.offline_reference is None:
