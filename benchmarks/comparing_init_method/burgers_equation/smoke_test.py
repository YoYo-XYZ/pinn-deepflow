"""Run the shared-harness smoke path for Burgers initializations."""
...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="deepflow-burgers-init-smoke-") as directory:
